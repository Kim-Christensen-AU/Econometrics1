...
\begin{frame}{Impact of job training on firm productivity}
\begin{enumerate}
...
\begin{frame}{FE model - ``within''/FE estimator}
\begin{enumerate}
...
\begin{frame}{Impact of job training on firm productivity - FE}
...
\begin{frame}{FE model - ``between'' estimator}
\begin{enumerate}
...
\begin{frame}{FE model - first difference estimator}
\begin{enumerate}
...
\begin{frame}{RE model - GLS estimator}
\begin{enumerate}
...
\begin{frame}{Cluster-robust inference}
\begin{enumerate}
...
\begin{frame}{FE vs.\ RE models - Hausman test}
\begin{enumerate}
\item[$\Rightarrow$] It is hard to choose between the FE and RE estimators
\item[$\Rightarrow$] One criteria can be built upon whether $\alpha_i$ and $\vx_{it}$ are uncorrelated
